<x-layout>
    <section >
            <div class="nav_objects" ><h2>{{__('app.login page')}}</h2></div>
            ...
            <div id="form_box">
                <form  id="form" action="{{route('login')}}" method="POST">
                    ...
                    <div class="form_element">
                        ...
                        <input type="password"  name="password"  required placeholder="{{__('app.password')}}" value="{{old('password')}}">

                    </div>
                    
                    <div class="form_element form_button">
                        <label for="submit"></label>
                        <input type="submit" value="{{__('app.login')}}" id="submit">
                    </div>  
